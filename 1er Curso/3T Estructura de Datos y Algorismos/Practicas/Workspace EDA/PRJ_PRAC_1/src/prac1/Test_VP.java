...
public class Test_VP {
	...
	public static void main (String [] args) {
		...
		try {
			vp.enter(comms[2]);
			vp.enter(privs[0]);
			notificarError("enter no ha llan�at AlreadySotoredException per a vehicles reptits", SORTIR);
		}
		...
		try {
			...
			notificarError("enter no ha llan�at NullPointerException per a vehicle null", SORTIR);
